...
export default function DashboardPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize: 14, fontWeight: 600, color: "var(--gold)", marginBottom: 2 }}>
              Bem-vindo ao Desafio Semente!
            </p>
            <p style={{ fontSize: 13, color: "var(--text-2)" }}>
              Sua jornada de 60 dias começa agora. Que cada semente plantada transforme sua vida.
            </p>
          </div>
        </div>
      )}
      ...
      {challenge?.phase && challenge.dayInPhase !== null && challenge.phaseTotal !== null && (
        <div style={{
          background: "linear-gradient(135deg, rgba(200,165,90,0.08) 0%, rgba(200,165,90,0.02) 100%)",
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ fontSize: 20 }}>{challenge.phaseIcon}</span>
              <div>
                <p style={{ fontSize: 12, fontWeight: 600, color: "var(--gold)", letterSpacing: "0.06em" }}>
                  {challenge.phase}
                </p>
                <p style={{ fontSize: 11, color: "var(--text-3)", fontStyle: "italic" }}>
                  "{challenge.phaseMotto}"
                </p>
              </div>
            </div>
            <div style={{ textAlign: "right" }}>
              <p style={{
                ...
                {challenge.dayInPhase}
                <span style={{ fontSize: 14, color: "var(--text-3)", fontWeight: 300 }}> / {challenge.phaseTotal}</span>
              </p>
              <p style={{ fontSize: 10, color: "var(--text-3)", letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 2 }}>
                dias
              </p>
            </div>
          </div>
          ...
          {/* Barra de progresso */}
          <div style={{ height: 4, background: "rgba(200,165,90,0.12)", borderRadius: 4, overflow: "hidden" }}>
            <div style={{
              height: "100%",
              width: `${challenge.progress}%`,
              background: "linear-gradient(90deg, rgba(200,165,90,0.6), var(--gold))",
              borderRadius: 4,
          ...
          <p style={{ fontSize: 11, color: "var(--text-3)", marginTop: 10, textAlign: "center" }}>
            Dia {challenge.dayNumber} da sua jornada · {challenge.progress}% da fase concluída
          </p>
        </div>
      )}
      ...
      <div style={{
        ...
        <div
          ...
          style={{
            position: "absolute",
            inset: 0,
            background: "radial-gradient(ellipse 70% 60% at 80% 50%, rgba(200,165,90,0.07) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
          ...
          <Link href="/devocionais" style={{ fontSize: 12, color: "var(--ink-3)", display: "flex", alignItems: "center", gap: 4 }}>
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize: 13, fontWeight: 500, color: "var(--text)", marginBottom: 4 }}>
              Plano Grátis — 1 semente por semana
            </p>
            <p style={{ fontSize: 12, color: "var(--text-2)" }}>
              Aceite o Desafio Semente por R$27/mês e receba sua palavra todo dia.
            </p>
          </div>
          <Link
            href="/quiz/presell"
